					...
					<div className={styles.table_wrapper}>
						<div className={styles.table_title}>
							<div className="row">
								...
								<div className="col-sm-6">
									<a href="#addEmployeeModal" className="btn btn-success" data-toggle="modal" style={{ ...{ float: "right" }, ...{ marginLeft: "5%" } }} onClick={openModal}><i className="material-icons">&#xE147;</i> <span>Add New Book</span></a>
