					...
					<div className={styles.table_wrapper}>
						<div className={styles.table_title}>
							<div className="row">
								...
								<div className="col-sm-6">
									<a href="#addEmployeeModal" className="btn btn-success" data-toggle="modal" style={{ ...{ float: "right" }, ...{ marginLeft: "5%" } }} onClick={openModal}><i className="material-icons">&#xE147;</i> <span>Add New Account</span></a>
						...
						<table className="table table_striped table_hover">
							...
							<tbody>
								<tr>
									...
									<a className="edit" data-toggle="modal" style={{ float: "left" }} ><i data-toggle="tooltip" title="Edit" onClick={openModal}><FaEdit /><EditUser isOpen={isOpen} setIsOpen={setIsOpen} /></i></a>
